...
//			printf ( "\r\n%s\r\n", strEsp8266_Fram_Record .Data_RX_BUF );//
			...
			else if ( strstr ( strEsp8266_Fram_Record .Data_RX_BUF, "CMD_READ_ALL_END" ) != 0 )     //读取所有的状态数据
			{
				DHT11_Read_TempAndHumidity ( & DHT11_Data ); //读取 DHT11 温湿度信息
